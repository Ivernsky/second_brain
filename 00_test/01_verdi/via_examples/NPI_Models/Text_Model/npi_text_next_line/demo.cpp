...
int main(int argc, char** argv)
{
  ...
  npiTextHandle next_line_hdl = npi_text_next_line(line_20_hdl);
  printf("\nNext line (line %d):\n", npi_text_property(npiTextLineNumber, next_line_hdl));
  printf("==========================\n");
  printf("%s", npi_text_property_str(npiTextLineContent, next_line_hdl));
  printf("==========================\n");
