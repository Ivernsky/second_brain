...
::npi_L1::npi_nl_trace_load_by_hdl_dump $hdl "stdout" 0 0
puts "Pass through assign and module"
::npi_L1::npi_nl_trace_load_by_hdl_dump $hdl "stdout" 0 1
puts "Do not pass through assign, pass through module"
::npi_L1::npi_nl_trace_load_by_hdl_dump $hdl "stdout" 1 1
puts "Do not pass through assign and module"
::npi_L1::npi_nl_trace_load_by_hdl_dump $hdl "stdout" 1 0
