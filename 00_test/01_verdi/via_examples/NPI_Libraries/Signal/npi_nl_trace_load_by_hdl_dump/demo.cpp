...
int main(int argc, char** argv)
{
  ...
  npi_nl_trace_load_by_hdl_dump(hdl, stdout, 0, 0);
  printf("Pass through assign and module\n");
  npi_nl_trace_load_by_hdl_dump(hdl, stdout, 0, 1);
  printf("Do not pass through assign, pass through module\n");
  npi_nl_trace_load_by_hdl_dump(hdl, stdout, 1, 1);
  printf("Do not pass through assign and module\n");
  npi_nl_trace_load_by_hdl_dump(hdl, stdout, 1, 0);
