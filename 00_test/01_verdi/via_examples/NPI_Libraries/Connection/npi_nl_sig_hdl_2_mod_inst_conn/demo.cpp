...
int main(int argc, char** argv)
{
  ...
  npi_nl_sig_hdl_2_mod_inst_conn(hdl, hdlVec);
  npi_nl_ut_dump_hdl_vec_info(hdlVec, stdout);
  printf("Do not pass through assign\n");
  npi_nl_sig_hdl_2_mod_inst_conn(hdl, hdlVec, 1);
  npi_nl_ut_dump_hdl_vec_info(hdlVec, stdout);

  printf("\n");

  printf("Pass through assign, stop at port/instport\n");
  npi_nl_sig_hdl_2_mod_inst_conn(hdl, hdlVec, 0, true);
  npi_nl_ut_dump_hdl_vec_info(hdlVec, stdout);
  printf("Do not pass through assign, stop at port/instport\n");
  npi_nl_sig_hdl_2_mod_inst_conn(hdl, hdlVec, 1, true);
  npi_nl_ut_dump_hdl_vec_info(hdlVec, stdout);
