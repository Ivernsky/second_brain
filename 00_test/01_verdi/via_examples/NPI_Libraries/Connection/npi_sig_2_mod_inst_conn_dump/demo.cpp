...
int main(int argc, char** argv)
{
  ...
  npi_sig_2_mod_inst_conn_dump("TOP.w1", stdout);
  printf("Do not pass through assign\n");
  npi_sig_2_mod_inst_conn_dump("TOP.w1", stdout, 1);

  printf("\n");

  printf("Pass through assign, stop at port/instport\n");
  npi_sig_2_mod_inst_conn_dump("TOP.w1", stdout, 0, true);
  printf("Do not pass through assign, stop at port/instport\n");
  npi_sig_2_mod_inst_conn_dump("TOP.w1", stdout, 1, true);
