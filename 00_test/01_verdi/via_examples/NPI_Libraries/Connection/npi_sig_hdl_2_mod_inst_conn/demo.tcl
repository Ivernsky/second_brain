...
::npi_L1::npi_sig_hdl_2_mod_inst_conn $hdl "hdlList"
::npi_L1::npi_nl_ut_dump_hdl_vec_info "hdlList" "stdout"
puts "Do not pass through assign"
::npi_L1::npi_sig_hdl_2_mod_inst_conn $hdl "hdlList" "1"
::npi_L1::npi_nl_ut_dump_hdl_vec_info "hdlList" "stdout"

puts ""

puts "Pass through assign, stop at port/instport"
::npi_L1::npi_sig_hdl_2_mod_inst_conn $hdl "hdlList" "0" "1"
::npi_L1::npi_nl_ut_dump_hdl_vec_info "hdlList" "stdout"
puts "Do not pass through assign, stop at port/instport"
::npi_L1::npi_sig_hdl_2_mod_inst_conn $hdl "hdlList" "1" "1"
::npi_L1::npi_nl_ut_dump_hdl_vec_info "hdlList" "stdout"
