...
int main(int argc, char** argv)
{
  ...
  npi_sig_2_primitive_inst_conn("TOP.w5", hdlVec);
  npi_nl_ut_dump_hdl_vec_info(hdlVec, stdout);
  printf("Do not pass through assign\n");
  npi_sig_2_primitive_inst_conn("TOP.w5", hdlVec, 1);
  npi_nl_ut_dump_hdl_vec_info(hdlVec, stdout);

  printf("\n");

  printf("Pass through assign, stop at instport\n");
  npi_sig_2_primitive_inst_conn("TOP.w5", hdlVec, 0, true);
  npi_nl_ut_dump_hdl_vec_info(hdlVec, stdout);
  printf("Do not pass through assign, stop at instport\n");
  npi_sig_2_primitive_inst_conn("TOP.w5", hdlVec, 1, true);
  npi_nl_ut_dump_hdl_vec_info(hdlVec, stdout);
