...
::npi_L1::npi_nl_sig_hdl_2_mod_inst_conn_dump $hdl "stdout"
puts "Do not pass through assign"
::npi_L1::npi_nl_sig_hdl_2_mod_inst_conn_dump $hdl "stdout" "1"

puts ""

puts "Pass through assign, stop at port/instport"
::npi_L1::npi_nl_sig_hdl_2_mod_inst_conn_dump $hdl "stdout" "0" "1"
puts "Do not pass through assign, stop at port/instport"
::npi_L1::npi_nl_sig_hdl_2_mod_inst_conn_dump $hdl "stdout" "1" "1"
