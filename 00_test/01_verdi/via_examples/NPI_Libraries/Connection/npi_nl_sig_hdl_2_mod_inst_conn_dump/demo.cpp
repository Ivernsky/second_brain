...
int main(int argc, char** argv)
{
  ...
  npi_nl_sig_hdl_2_mod_inst_conn_dump(hdl, stdout);
  printf("Do not pass through assign\n");
  npi_nl_sig_hdl_2_mod_inst_conn_dump(hdl, stdout, 1);

  printf("\n");

  printf("Pass through assign, stop at port/instport\n");
  npi_nl_sig_hdl_2_mod_inst_conn_dump(hdl, stdout, 0, true);
  printf("Do not pass through assign, stop at port/instport\n");
  npi_nl_sig_hdl_2_mod_inst_conn_dump(hdl, stdout, 1, true);
